...
var initGlobalConfigFiles = function (config, assets) {
  ...
  config.files.client.css = getGlobbedPaths(assets.client.lib.css, 'public/').concat(getGlobbedPaths(assets.client.css, ['public/']));
   ...
   // Setting Admin js files
  config.files.client.adminjs = getGlobbedPaths(assets.client.lib.adminjs, 'public/').concat(getGlobbedPaths(assets.client.js, ['public/']));

  // Setting Admin css files
  config.files.client.admincss = getGlobbedPaths(assets.client.lib.admincss, 'public/').concat(getGlobbedPaths(assets.client.css, ['public/']));
