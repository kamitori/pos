    ...
    user.save(function (err) {
      ...
      agent.post('/api/auth/signin')
        ...
        .end(function (signinErr, signinRes) {
          ...
          var userUpdate = {
            first_name: 'admin_update_first',
            last_name: 'admin_update_last',
            roles: ['admin']
          };
          ...
          agent.put('/api/users/' + user._id)
            ...
            .end(function (userInfoErr, userInfoRes) {
              ...
              userInfoRes.body.should.be.instanceof(Object);
              userInfoRes.body.first_name.should.be.equal('admin_update_first');
              userInfoRes.body.last_name.should.be.equal('admin_update_last');
    ...
    user.save(function (err) {
      ...
      agent.post('/api/auth/signin')
        ...
        .end(function (signinErr, signinRes) {
          ...
          var userUpdate = {
            first_name: 'user_update_first',
            last_name: 'user_update_last'
          };
          ...
          agent.put('/api/users')
            ...
            .end(function (userInfoErr, userInfoRes) {
              ...
              userInfoRes.body.should.be.instanceof(Object);
              userInfoRes.body.first_name.should.be.equal('user_update_first');
              userInfoRes.body.last_name.should.be.equal('user_update_last');
              userInfoRes.body.roles.should.be.instanceof(Array).and.have.lengthOf(1);
