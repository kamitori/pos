...
describe('Users E2E Tests:', function () {
  ...
  describe('Signup Validation', function () {
    it('Should report missing first name', function () {
      ...
      // Enter Last Name
      element(by.model('vm.credentials.last_name')).sendKeys(user1.last_name);
      // Enter Email
    ...
    it('Should report missing last name', function () {
      browser.get('http://localhost:3001/authentication/signup');
      // Enter First Name
      element(by.model('vm.credentials.first_name')).sendKeys(user1.first_name);
      // Enter Email
      element(by.model('vm.credentials.email')).sendKeys(user1.email);
      // Enter Username
      element(by.model('vm.credentials.username')).sendKeys(user1.username);
    ...
    it('Should signup username with . - "log.in"', function () {
      browser.get('http://localhost:3001/authentication/signup');
      // Enter First Name
      element(by.model('vm.credentials.first_name')).sendKeys(user2.first_name);
      // Enter Last Name
      element(by.model('vm.credentials.last_name')).sendKeys(user2.last_name);
      // Enter Email
